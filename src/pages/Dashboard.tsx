...
const Dashboard = () => {
  ...
  const { progress, status, result, startBrewing, reset, loadStoredAnalysis, guestLimitReached, error: brewingError, scansDisabled } = useBrewing();
          ...
          <div className="flex flex-col items-center justify-center min-h-[50vh] text-center gap-4 px-4">
            ...
            <div>
              <p className="text-sm font-medium text-foreground">
                {scansDisabled ? 'Scanning is paused' : "Couldn't complete the scan"}
              </p>
